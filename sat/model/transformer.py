...
class CrossAttention(torch.nn.Module):
    ...
    def forward(self, hidden_states, cross_attention_mask, image_encoder_outputs, **kw_args):
        ...
        if 'cross_attention_forward' in self.hooks:
            ...
            return HOOKS_DEFAULT['cross_attention_forward'](self, hidden_states, cross_attention_mask, image_encoder_outputs, **kw_args)
...
class BaseTransformer(torch.nn.Module):
    ...
    def forward(self, input_ids, position_ids, attention_mask, *,
        ...
        if 'word_embedding_forward' in self.hooks:
            hidden_states = self.hooks['word_embedding_forward'](input_ids, output_cross_layer=output_cross_layer, **kw_args) #图像patch化和文本向量拼接,(2,226+13*1350,1920)
        else:  # default
